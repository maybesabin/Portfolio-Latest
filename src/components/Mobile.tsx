        ...
        <div className="lg:hidden flex flex-col items-center justify-center gap-4 w-full md:px-9 h-auto pb-12">
            ...
            <div className="flex md:flex-row flex-col items-center justify-between gap-4 w-full">
                ...
                <div className="md:w-1/2 w-full h-full relative group popup">
                    ...
                    <div className={`absolute ${isDarkMode ? "bg-gradient-to-b from-[#212121] to-[#121212]" : "bg-gray-100"}  flex items-center justify-between px-6 cursor-pointer top-[35%] left-[50%] w-[60%] xl:h-32 h-28 rounded-3xl group`} style={{ transform: "translate(-50%, -50%)" }}>
