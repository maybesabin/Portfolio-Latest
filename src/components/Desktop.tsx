    ...
    return (
        <div className="lg:flex hidden items-start justify-between gap-4 w-full xl:h-[22rem] h-auto ">
            ...
            <div className="w-1/4 relative group popup">
                ...
                <Link to="/credentials"><img src={coding} className="w-[150px] absolute cursor-pointer top-[40%] left-[50%] opacity-75 group-hover:opacity-100 transition-all duration-500" style={{ transform: "translate(-50%, -60%)" }} alt="" />
                </Link>
            </div>

            <div className={`w-2/4 xl:h-[18rem] lg:h-[16rem] ${isDarkMode ? "bg-[#131313] shadow-none " : "bg-white shadow-lg "} group cursor-pointer flex flex-col items-start justify-center gap-10 xl:text-5xl text-4xl font-semibold rounded-[2.5rem] px-6 relative popup`}>
            ...
            <div className="w-1/4 h-full relative group popup">
                ...
                <div className={`absolute ${isDarkMode ? "bg-gradient-to-b from-[#212121] to-[#121212]" : "bg-gray-100"}  flex items-center justify-between px-6 cursor-pointer top-[35%] left-[50%] w-[80%] xl:h-32 h-28 rounded-3xl group`} style={{ transform: "translate(-50%, -50%)" }}>

                    <div className={`${isDarkMode ? "bg-zinc-800" : " bg-white"} rounded-full xl:p-5 p-3 social-div`}>
