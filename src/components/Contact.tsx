    ...
    const contactInfo = [
        {
            ...
            svg: <svg xmlns="http://www.w3.org/2000/svg" className={`${isDarkMode ? "text-white" : "text-black"}`} viewBox="0 0 24 24" width="44" height="44" fill="none">
        ...
        },
        {
            title: "contact me",
            data: "+977 9829100636",
            svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="44" height="44" fill="none">
            ...
            <div className="flex items-start justify-between gap-12 xl:w-[75rem] w-[90%] h-full pt-12 ">
                <div className="flex flex-col items-start gap-9">
                    ...
                    <div className="flex items-center gap-6 popup">
                        ...
                        <div className={`${isDarkMode ? "bg-zinc-800" : " bg-white shadow-lg"} rounded-full xl:p-5 p-3 social-div cursor-pointer`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`${isDarkMode ? "text-white" : "text-blue-500"} xl:w-[44px] xl:h-[44px] w-[30px] h-[30px]`} fill="none">
