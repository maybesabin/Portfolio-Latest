        ...
        emailjs
            ...
            .then(
                () => {
                    toast({
                        title: "Success!",
                        description: "Your email has been sent successfully. We'll get back to you shortly.",
                    })
                },
                (error) => {
                    toast({
                        title: "Failed",
                        description: `Oops! Something went wrong while sending your email.  ${error.text}`,
                    })
                }
            );
    };
            ...
            <div className="flex items-start md:flex-row flex-col md:gap-0 gap-12 justify-between xl:px-6 px-0 xl:w-[75rem] w-[90%] h-full md:pt-[12rem] pt-[8rem]">
                <div className="flex flex-col items-start gap-9">
                    ...
                    <div className="flex items-center gap-6 popup">
                        <a href="https://x.com/16calc" target="_blank" className={`${isDarkMode ? "bg-zinc-800" : " bg-white shadow-sm"} cursor-pointer rounded-full xl:p-5 p-3 social-div`}>
                        ...
                        <a href="https://github.com/maybesabin" target="_blank" className={`${isDarkMode ? "bg-zinc-800" : " bg-white shadow-sm"} rounded-full xl:p-5 p-3 social-div cursor-pointer`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`${isDarkMode ? "text-white" : "text-blue-500"} xl:w-[44px] xl:h-[44px] w-[30px] h-[30px]`} fill="none">
                        ...
                        <a href="https://www.linkedin.com/in/sabinhamal/" target="_blank" className={`${isDarkMode ? "bg-zinc-800" : " bg-white shadow-sm"} rounded-full xl:p-5 p-3 social-div cursor-pointer`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`${isDarkMode ? "text-white" : "text-blue-500"} xl:w-[44px] xl:h-[44px] w-[30px] h-[30px]`} fill="none">
                ...
                <div className={`${isDarkMode ? "bg-gradient-to-br" : "bg-white shadow-sm"} popup flex flex-col items-start justify-evenly md:gap-6 lg:w-[40rem] md:w-[30rem] w-full rounded-3xl px-6  from-[#202020] to-[#111111] md:h-[37rem] h-[32rem]`}>
                    ...
                    <div className="flex items-center justify-between w-full">
                        <h1 className="font-bold lg:text-5xl sm:text-3xl text-2xl">Want a<span className="text-[#585198]"> website ?</span> <br />Send me a message<span className="text-[#585198]">.</span></h1>
